...
if [ -f "uninstall_clean.sh" ]; then
    cp "uninstall_clean.sh" "${APP_BUNDLE}/Contents/Resources/"
    chmod +x "${APP_BUNDLE}/Contents/Resources/uninstall_clean.sh"
    echo "Uninstall script bundled successfully"
else
    echo "Warning: uninstall_clean.sh not found"
fi
